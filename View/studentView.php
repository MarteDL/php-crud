    ...
    <section>
        <table style="width:100%">
            ...
            <tr>
                ...
                <td><a href="?teacherID=<?php echo $student->getTeacher() ?>"><?php echo $student->getTeacher() ?></a>
                </td>
                <td>
                <td>
                    ...
                    <!-- edit button -->
                    <a href="?page=students&edit=<?php echo $student->getId() ?>" class="btn btn-primary">Edit
                        student</a>
                </td>
                </td>
            </tr>
